...
import type { ReleaseFormData, TrackFormData, MusicTrackData, MusicPlaylistData, TrackReference } from '@/types/podcast';
...
async function convertTrackFormDataToMusicTrackData(
  ...
  const trackData: MusicTrackData = {
    ...
    title: track.title,
    artist: releaseData.title, // Use release title as artist for now, could be made configurable
    audioUrl,
