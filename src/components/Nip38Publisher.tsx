...
/**
 * Component that automatically publishes NIP-38 status updates for podcast releases
 ...
 * are published whenever the user is playing podcast releases.
 * 
 * The status updates will appear next to the user's name in compatible Nostr clients
 * and include a nevent link back to the release for proper Nostr routing.
 */
